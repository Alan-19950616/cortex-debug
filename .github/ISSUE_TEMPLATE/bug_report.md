...
Please read our documentation as well. You have a lot of control over how General-Debug works. Besides the top level [README.md](https://github.com/Marus/cortex-debug/blob/master/README.md), we have the following

https://github.com/Marus/cortex-debug/wiki
https://github.com/Marus/cortex-debug/wiki/General-Debug-Under-the-hood
...
[comment]: <> Whenever possible, please make sure you are using the latest versions of VSCode and our extension
 ...
 - General-Debug Version (this extension) [e.g. 0.2.3]
